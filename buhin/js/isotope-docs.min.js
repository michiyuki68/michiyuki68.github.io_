...
! function(t, i) {
    ...
    var s = document.documentElement.style,
        r = "string" == typeof s.ctgr_itimen ? "ctgr_itimen" : "Webkitctgr_itimen",
        a = "string" == typeof s.transform ? "transform" : "WebkitTransform",
        h = {
            Webkitctgr_itimen: "webkitctgr_itimenEnd",
            ctgr_itimen: "ctgr_itimenend"
        }[r],
        l = {
            transform: a,
            ctgr_itimen: r,
            ctgr_itimenDuration: r + "Duration",
            ctgr_itimenProperty: r + "Property",
            ctgr_itimenDelay: r + "Delay"
        },
    ...
    u.constructor = o, u._create = function() {
        ...
        if (this.setPosition(t, i), r && !this.isctgr_itimening) return void this.layoutPosition();
        var a = t - n,
            h = i - o,
            l = {};
        l.transform = this.getTranslate(a, h), this.ctgr_itimen({
            to: l,
            onctgr_itimenEnd: {
    ...
    }, u.moveTo = u._ctgr_itimenTo, u.setPosition = function(t, i) {
        this.position.x = parseInt(t, 10), this.position.y = parseInt(i, 10)
    }, u._nonctgr_itimen = function(t) {
        this.css(t.to), t.isCleaning && this._removeStyles(t.to);
        for (var i in t.onctgr_itimenEnd) t.onctgr_itimenEnd[i].call(this)
    }, u.ctgr_itimen = function(t) {
        if (!parseFloat(this.layout.options.ctgr_itimenDuration)) return void this._nonctgr_itimen(t);
        var i = this._transn;
        for (var n in t.onctgr_itimenEnd) i.onEnd[n] = t.onctgr_itimenEnd[n];
        ...
        this.enablectgr_itimen(t.to), this.css(t.to), this.isctgr_itimening = !0
    };
    var d = "opacity," + e(a);
    u.enablectgr_itimen = function() {
        if (!this.isctgr_itimening) {
            var t = this.layout.options.ctgr_itimenDuration;
            t = "number" == typeof t ? t + "ms" : t, this.css({
                ctgr_itimenProperty: d,
                ctgr_itimenDuration: t,
                ctgr_itimenDelay: this.staggerDelay || 0
            }), this.element.addEventListener(h, this, !1)
        }
    }, u.onwebkitctgr_itimenEnd = function(t) {
        this.onctgr_itimenend(t)
    }, u.onoctgr_itimenend = function(t) {
        this.onctgr_itimenend(t)
    };
    var p = {
        "-webkit-transform": "transform"
    };
    u.onctgr_itimenend = function(t) {
        if (t.target === this.element) {
            var i = this._transn,
                o = p[t.propertyName] || t.propertyName;
            if (delete i.ingProperties[o], n(i.ingProperties) && this.disablectgr_itimen(), o in i.clean && (this.element.style[t.propertyName] = "", delete i.clean[o]), o in i.onEnd) {
                var e = i.onEnd[o];
                e.call(this), delete i.onEnd[o]
            }
            this.emitEvent("ctgr_itimenEnd", [this])
        }
    }, u.disablectgr_itimen = function() {
        this.removectgr_itimenStyles(), this.element.removeEventListener(h, this, !1), this.isctgr_itimening = !1
    ...
    return u.removectgr_itimenStyles = function() {
        this.css(f)
        ...
        return r && parseFloat(this.layout.options.ctgr_itimenDuration) ? (this.once("ctgr_itimenEnd", function() {
            this.removeElem()
        ...
        var t = this.layout.options,
            i = {},
            n = this.getHideRevealctgr_itimenEndProperty("visibleStyle");
        i[n] = this.onRevealctgr_itimenEnd, this.ctgr_itimen({
            from: t.hiddenStyle,
            to: t.visibleStyle,
            isCleaning: !0,
            onctgr_itimenEnd: i
        })
    }, u.onRevealctgr_itimenEnd = function() {
        this.isHidden || this.emitEvent("reveal")
    }, u.getHideRevealctgr_itimenEndProperty = function(t) {
        ...
        var t = this.layout.options,
            i = {},
            n = this.getHideRevealctgr_itimenEndProperty("hiddenStyle");
        i[n] = this.onHidectgr_itimenEnd, this.ctgr_itimen({
            from: t.visibleStyle,
            to: t.hiddenStyle,
            isCleaning: !0,
            onctgr_itimenEnd: i
        })
    }, u.onHidectgr_itimenEnd = function() {
...
! function(t, e) {
    ...
    d._create = function() {
        ...
        this.filteredItems = e.matches, this._bindArrangeComplete(), this._isInstant ? this._noctgr_itimen(this._hideReveal, [e]) : this._hideReveal(e), this._sort(), this._layout()
    ...
    }, d._noctgr_itimen = function(t, e) {
        var i = this.options.ctgr_itimenDuration;
        this.options.ctgr_itimenDuration = 0;
        var r = t.apply(this, e);
        return this.options.ctgr_itimenDuration = i, r
...
! function(e, t) {
    ...
    return r.moveTo = function(e, t) {
        var i = Math.abs(this.position.x - e),
            ...
            s = this.layout.dragItemCount && !this.isPlacing && !this.isctgr_itimening && i < 1 && o < 1;
        return s ? void this.goTo(e, t) : void a.apply(this, arguments)
    }, r.enablePlacing = function() {
        this.removectgr_itimenStyles(), this.isctgr_itimening && o && (this.element.style[o] = "none"), this.isctgr_itimening = !1, this.getSize(), this.layout._setRectSize(this.element, this.rect), this.isPlacing = !0
...
glblFilter = e;
    ...
    }), e.find(".grid__item").on("click",  function() {
//      window.alert( "grid__item Click!!" ) ;
...
IsotopeDocs.notification = function(t) {
    ...
    var i, s = document.documentElement,
        c = "string" == typeof s.style.ctgr_itimen ? "ctgr_itimen" : "Webkitctgr_itimen";
...
IsotopeDocs["animate-item-size-responsive"] = function(t) {
    ...
    var s = document.documentElement.style,
        o = "string" == typeof s.ctgr_itimen ? "ctgr_itimen" : "Webkitctgr_itimen",
        r = {
            Webkitctgr_itimen: "webkitctgr_itimenEnd",
            ctgr_itimen: "ctgr_itimenend"
        }[o],
