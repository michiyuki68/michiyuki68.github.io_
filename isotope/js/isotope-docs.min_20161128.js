...
! function(t, i) {
    ...
    g._create = function() {
        ...
        if (o = o && o + this.gutter) {
            ...
            n = (c - g) * o;
            for (var u = 0; u < c; u++) this._addShiftTarget(u * o, 0, n)
        ...
        d.forEach(function(t) {
            ...
            if (this._addShiftTarget(e, s, n), o)
                for (var h = Math.round(i[a] / o), g = 1; g < h; g++) {
                    var c = r ? e : i.x + o * g,
                        u = r ? i.y + o * g : s;
...
glblFilter = e;
    ...
    }), e.find(".element-item").on("click",  function() {
//      window.alert( "element-item Click!!" ) ;
