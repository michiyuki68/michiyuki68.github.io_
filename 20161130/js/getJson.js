...
//        ulObj1.append($('<a class="grid__item ' + data[i].Category + '" href="#" data-category="' + data[i].category + '"><h2 class="title title--preview">' + data[i].Headline + '</h2><div class="loader"></div><div class="meta">' + firstBodyPreview + '</div>'));
        ...
        ulObj1.append($('<a class="grid__item ' + data[i].Category + '" href="#" data-category="' + data[i].category + '"><h2 class="title title--preview">' + data[i].Headline + '</h2><div class="loader"><span class="category">' + data[i].Category + '</span><div class="meta meta==preview"><img class="meta__avatar" src="img/authors/1.png" alt="author01" /><span class="meta__date"><i class="fa fa-calendar-o"></i>' + data[i].Headline +' </span><span class="meta__reading-time"><i class="fa fa-clock-o"></i>' + bodyLength + '文字' +  '</span></div>'));
