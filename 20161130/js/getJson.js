...
console.log('data.json１とおってるよ');
        ...
        ulObj2.append($('<article class="content__item"><span class="category category--full">Stories for humans</span><h2 class="title title--full"><div>' + data[i].Headline + '</div></h2><div class="meta meta--full"><img alt="author01" class="meta__avatar" src="img/authors/1.png"><span class="meta__author">' + data[i].Category + '</span><span class="meta__date"><i class="fa fa-calendar-o"></i> 9 Apr</span><span class="meta__reading-time"><i class="fa fa-clock-o"></i> 3 min read</span></div><div>' + data[i].FirstBody + '</div><div>' + data[i].Body +'</div><p>ここまで</p></article>'));
    }
